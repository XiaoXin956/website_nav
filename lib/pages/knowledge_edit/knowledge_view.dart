...
class _KnowledgePageState extends State<KnowledgePage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => KnowledgeBloc()..add(LabelSearchEvent(data: {"type": "parent"})),
                                              ...
                                              Expanded(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      child: (selectParentValue == null) ? Text("${S.of(context).please_select}") : Text("${selectParentValue?.name.toString()}"),
                                                    ),
                                                  ))
                                            ],
                                          )),
